                        ...
                        <div class="projectsmain">
                            <div class="firstproject">
                                ...
                                <div class="firstprojectimg">
                                    <a href="https://pateldhruv29.github.io/weather/" target="_blank">
                            ...
                            <div class="secondproject">
                                <div class="secondprojectname">2.SKYTECH CLONE</div>
                                <div class="secondprojectimg">
                                <a href="https://pateldhruv29.github.io/skytech/" target="_blank">
                                        <img src={require('./images/skytechimg.png')}></img>
                                    </a>
                                </div>
                                <div class="secondprojectdes">The Skytech website clone is a modern and versatile platform designed for technology, IT solutions, and software businesses. It replicates the sleek and professional design of the original Skytech template, offering an ideal solution for showcasing services like cloud computing, software development, cybersecurity, and more.</div>
                            </div>
                            <div class="thirdproject">
                                <div class="thirdprojectname">3.AGRUCO CLONE</div>
                                <div class="thirdprojectimg">
                                    <a href="https://pateldhruv29.github.io/agruco/" target="_blank">
                            ...
                            <div class="fourthproject">
                                <div className="fourthprojectname">4.FLIPCART CLONE</div>
                                <div class="fourthprojectimg">
                                <a href="https://pateldhruv29.github.io/flipcart/" target="_blank">
                                        <img src={require('./images/flipcartimg.png')}></img>
                                    </a>
                    
                                </div>
                                <div class="fourthprojectdes">Our Flipkart clone is a feature-rich e-commerce platform designed to replicate the functionality and user experience of Flipkart. It allows users to browse and purchase a wide range of products, including electronics, fashion, home essentials, and more. With advanced search filters, secure payment gateways, and a seamless checkout process, the website ensures a smooth shopping experience.</div>
                            </div>
                        </div>
